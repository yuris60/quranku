      ...
      body: BlocConsumer<DatabaseCubit, DatabaseState>(
        listener: (context, state) {
          if (state is LoadDatabaseState) {
            _surah = SurahCubit(database: context.read<DatabaseCubit>().database!);
            // surah & juz masuk kesini
          }
        },
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: TabBar(
                        ...
                        labelStyle: TextStyle(color: Palette.primary, fontSize: 16 *
                            ffem, fontWeight: FontWeight.bold),
                        tabs: [
                          Tab(text: "Surah"),
                          Tab(text: "Juz"),
                          Tab(text: "Halaman"),
                      ...
                      child: TabBarView(
                        children: <Widget>[
                                  ...
                                  Container(
                                    ...
                                    child: ListTile(
                                        ...
                                        IconButton(
                                          ...
                                          icon: Icon(
                                              Icons.cancel, color: Palette.primary),
                                        )
                                    ),
                                  ),

                                  BlocProvider<SurahCubit>(
                                    create: (context) => _surah!..getListSurah(),
                                                ...
                                                children: [
                                                  ListTile(
                                                    ...
                                                    subtitle: Text(surah.arti! + " (" +
                                                        surah.jml_ayat!.toString() +
                                                        " ayat)", style: TextStyle(
                                                        fontSize: 10 * ffem),),
                          ...
                          RawScrollbar(
                            ...
                            child: SingleChildScrollView(
                              child: BlocProvider(
                                create: (context) => ListHalamanCubit(),
