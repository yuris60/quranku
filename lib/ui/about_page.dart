        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text("0.0.2", style: TextStyle(fontSize: 12*ffem, color: Colors.white)),
                  ),
                ],
              ),
              ...
              Text("Menstabilkan aplikasi dan memberikan icon pada launcher.", textAlign: TextAlign.center, style: TextStyle(fontSize: 15*ffem,)),
